        ...
        <View className="flex-1 px-6 pt-10 pb-8">
          ...
          <View className="space-y-4">
            ...
            <View>
              ...
              <View className={`flex-row items-center border rounded-lg px-4 py-3 bg-gray-50 ${errors.name ? 'border-red-400' : 'border-gray-300'}`}>
                <Ionicons name="person-outline" size={18} color={errors.name ? '#F87171' : '#6B7280'} />
                <TextInput
            ...
            <View>
              ...
              <View className={`flex-row items-center border rounded-lg px-4 py-3 bg-gray-50 ${errors.email ? 'border-red-400' : 'border-gray-300'}`}>
                <Ionicons name="mail-outline" size={18} color={errors.email ? '#F87171' : '#6B7280'} />
                <TextInput
                  className="flex-1 ml-2 text-gray-800"
            ...
            <View>
              ...
              <View className={`flex-row items-center border rounded-lg px-4 py-3 bg-gray-50 ${errors.password ? 'border-red-400' : 'border-gray-300'}`}>
                <Ionicons name="lock-closed-outline" size={18} color={errors.password ? '#F87171' : '#6B7280'} />
                <TextInput
                  className="flex-1 ml-2 text-gray-800"
            ...
            <View>
              ...
              <View className={`flex-row items-center border rounded-lg px-4 py-3 bg-gray-50 ${errors.confirmPassword ? 'border-red-400' : 'border-gray-300'}`}>
                <Ionicons name="lock-closed-outline" size={18} color={errors.confirmPassword ? '#F87171' : '#6B7280'} />
                <TextInput
                  className="flex-1 ml-2 text-gray-800"
            ...
            {/* Signup Button */}
            <TouchableOpacity
              className={`mt-6 py-3.5 rounded-lg items-center ${loading ? 'bg-blue-400' : 'bg-blue-600'}`}
          ...
          <View className="flex-row justify-center space-x-6">
            <TouchableOpacity
              className="w-14 h-14 border border-gray-300 rounded-full items-center justify-center shadow-sm bg-white"
